...
import {fromGitLoader, fromGithubLoader} from '@graphql-inspector/load';
...
const graphqlInspectorExtension: GraphQLExtensionDeclaration = api => {
  // schema
  api.loaders.schema.register(fromGitLoader);
  api.loaders.schema.register(fromGithubLoader);
